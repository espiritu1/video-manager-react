...
export const Aside = ({  show, position = "left", onClose, children, title, }) => {
	...
	return (
		<>
			...
			<aside className={` fixed top-0 ${isLeft ? "left-0" : "right-0"} h-full  w-[75%] lg:w-[45%] bg-amber-50 dark:bg-kanagawa-700 z-40 shadow-xl transform transition-transform duration-300
				...
				{/* Header */}
				<div className={`p-4 flex justify-between items-center border-b border-kanagawa-600 ${!isLeft && "flex-row-reverse"}`}>
